...
BufferGeometry::BufferGeometry(const BufferGeometry& source) : Geometry(source){
    ...
    for (auto attr = source.attributes.begin();attr != source.attributes.end();) {
        BufferAttribute<float>::sptr newAttr = std::make_shared<BufferAttribute<float>>();
...
/*BufferGeometry& BufferGeometry::setPosition(const BufferAttribute<float>::sptr& position)
{
    this->position.reset();
    this->position = position;
    return *this;
}
BufferGeometry& BufferGeometry::setNormal(const BufferAttribute<float>::sptr& normal)
{
    this->normal.reset();
    this->normal = normal;
    return *this;
}
BufferGeometry& BufferGeometry::setColor(const BufferAttribute<float>::sptr& color)
{
    this->color.reset();
    this->color = color;
    return *this;
}
BufferGeometry& BufferGeometry::setUV(const BufferAttribute<float>::sptr& uv)
{
    this->uv.reset();
    this->uv = uv;
    return *this;
}
BufferGeometry& BufferGeometry::setUV2(const BufferAttribute<float>::sptr& uv2)
{
    this->uv2.reset();
    this->uv2 = uv2;
    return *this;
}
BufferGeometry& BufferGeometry::setTangent(const BufferAttribute<float>::sptr& tangent)
{
    this->tangent.reset();
    this->tangent = tangent;
    return *this;
}
BufferGeometry& BufferGeometry::setBitangent(const BufferAttribute<float>::sptr& bitangent)
{
    this->bitangent.reset();
    this->bitangent = bitangent;
    return *this;
}
BufferGeometry& BufferGeometry::setLineDistance(const BufferAttribute<float>::sptr& lineDistance)
{
    this->lineDistance.reset();
    this->lineDistance = lineDistance;
    return *this;
}
BufferGeometry& BufferGeometry::setSkinIndexAttribute(const BufferAttribute<float>::sptr& skinIndexAttribute)
{
...
BufferGeometry& BufferGeometry::setSkinWeightAttribute(const BufferAttribute<float>::sptr skinWeightAttribute)
{
...
BufferGeometry& BufferGeometry::applyMatrix4(const Matrix4& matrix){
    ...
    if (normal != nullptr) {
        ...
        auto normalMatrix = Matrix3().getNormalMatrix(const_cast<Matrix4&>(matrix));
...
const BufferAttribute<unsigned>::sptr& BufferGeometry::mergeAttributeInt(const BufferAttribute<unsigned>::sptr& source, const BufferAttribute<unsigned>::sptr& target, int offset){
    ...
    auto length = std::min<double>(target->size, source->size - positionOffset);
...
BufferGeometry& BufferGeometry::merge(BufferGeometry& geometry, int offset){
    ...
    for (auto& attr : geometry.morphAttributes) {
        ...
        std::vector<BufferAttribute<float>::sptr> vec = attr.second;
...
void BufferGeometry::toNonIndexed(const BufferGeometry::sptr& geometry2)
{
    ...
    for (auto& attr : morphAttributes) {
        ...
        std::vector<BufferAttribute<float>::sptr> array;
        for (auto ptr : attr.second) {
            BufferAttribute<float>::sptr newPtr = BufferAttribute<float>::create();
            newPtr->copy(*ptr);
