...
int main(int, char**)
{
    ...
    std::cout << "Execute shell command:ls -l  output: " << execute_shell_command_with_result("echo \"radeon\" | sudo -S xattr -rd com.apple.quarantine ~/Applications/IINA.app") << std::endl; 
