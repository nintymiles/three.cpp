...
Line::Line(const Geometry::sptr& geometry, const Material::sptr& material) : Object3D(){
...
Line::Line(const Geometry::sptr& geometry, const std::vector<Material::sptr>& materials) : Object3D(){
    this->geometry = geometry != nullptr ? geometry : Geometry::create();
    if (materials.size() > 0) {
