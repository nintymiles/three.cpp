...
public:
    PMREMGenerator(GLRenderer::sptr renderer):_renderer(renderer){
...
private:
    ...
    void _allocateTargets();

    GLRenderTarget::sptr _createRenderTarget( int width, int height, GLRenderTargetParameter& params );
