...
#include "dodechedron_geometry.h"
...
DodecahedronBufferGeometry::DodecahedronBufferGeometry(float radius, float detail) :
    PolyhedronBufferGeometry(dodecahedron_buffergeometry::_vertices, dodecahedron_buffergeometry::_indices, radius, detail){}

DodecahedronGeometry::DodecahedronGeometry(float radius, float detail) : Geometry(){
    this->radius = radius;
    this->detail = detail;
