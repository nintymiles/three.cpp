...
void CylinderBufferGeometry::generateTorso(){
    int x, y;
    int groupCount = 0;
...
void CylinderBufferGeometry::generateCap(bool top){
...
CylinderBufferGeometry::CylinderBufferGeometry(float radiusTop, float radiusBottom, float height, float radialSegments, float heightSegments, bool openEnded, float thetaStart, float thetaLength) : BufferGeometry(){
...
CylinderGeometry::CylinderGeometry(float radiusTop, float radiusBottom, float height, float radialSegments, float heightSegments, bool openEnded, float thetaStart, float thetaLength) : Geometry(){
    this->radiusTop= radiusTop;
    this->radiusBottom= radiusBottom;
    this->height= height;
    ...
    CylinderBufferGeometry::sptr bufferGeometry = std::make_shared<CylinderBufferGeometry>(radiusTop,
                                                                                          radiusBottom,
                                                                                          height,
                                                                                          radialSegments,
                                                                                          heightSegments,
