...
void TeapotModel::Init() {
    ...
    mat_model_ = mat_model_ * Matrix4::makeScale(Cvec3(0.015,0.015,0.015));
    mat_model_ = mat_model_ * Matrix4::makeTranslation(Cvec3(-25.0,10.0,0.0));
    
    mat_model_ =  mat_model_ * Matrix4::makeXRotation(-90);
    mat_model_ =  mat_model_ * Matrix4::makeYRotation(45);
    mat_model_ =  mat_model_ * Matrix4::makeZRotation(0);
