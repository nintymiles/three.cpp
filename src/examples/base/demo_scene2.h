...
#ifndef THREE_CPP_DEMO_SCENE2_H
#define THREE_CPP_DEMO_SCENE2_H
...
class DemoScene2 : public ApplicationBase {
public:
    DemoScene2(int x, int y) :  ApplicationBase(x,y) {}
